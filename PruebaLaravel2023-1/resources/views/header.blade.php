    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img class="d-inline-block align-text-top" src="{{ asset('images/logoOYDWhite.png') }}" alt="OYD" width="auto" height="75">
                
            </a>
            <a class="navbar-brand" href="#">
                <span class="navbar-brand mb-0 h1 "><b class="text-color-1">GRUPO OYD</b></span>
            </a>
